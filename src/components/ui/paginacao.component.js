...
import criarCardProduto from '../produtos/card.component';
...
export function renderizarProdutos(
    ...
    const { onCarrinhoAlterado } = opcoes;
    ...
    produtosPaginados.forEach(produtos => {
        const coluna = criarColuna();
        const card = criarCardProduto(produtos, onCarrinhoAlterado);
